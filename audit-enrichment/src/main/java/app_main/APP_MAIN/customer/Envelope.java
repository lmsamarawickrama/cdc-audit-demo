...
public class Envelope extends org.apache.avro.specific.SpecificRecordBase implements org.apache.avro.specific.SpecificRecord {
  ...
  public static Envelope fromByteBuffer(
   ...
   private app_main.APP_MAIN.customer.Value before;
   private app_main.APP_MAIN.customer.Value after;
   ...
   */
  public Envelope(app_main.APP_MAIN.customer.Value before, app_main.APP_MAIN.customer.Value after, io.debezium.connector.mysql.Source source, java.lang.CharSequence op, java.lang.Long ts_ms, event.block transaction) {
    this.before = before;
    this.after = after;
    this.source = source;
    this.op = op;
  ...
  public void put(int field$, java.lang.Object value$) {
    switch (field$) {
    case 0: before = (app_main.APP_MAIN.customer.Value)value$; break;
    case 1: after = (app_main.APP_MAIN.customer.Value)value$; break;
   ...
   */
  public app_main.APP_MAIN.customer.Value getBefore() {
    return before;
  }
   ...
   */
  public void setBefore(app_main.APP_MAIN.customer.Value value) {
    this.before = value;
  }
   ...
   */
  public app_main.APP_MAIN.customer.Value getAfter() {
    return after;
  }
   ...
   * @param value the value to set.
   */
  public void setAfter(app_main.APP_MAIN.customer.Value value) {
    this.after = value;
  }
   ...
   */
  public static app_main.APP_MAIN.customer.Envelope.Builder newBuilder() {
    return new app_main.APP_MAIN.customer.Envelope.Builder();
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static app_main.APP_MAIN.customer.Envelope.Builder newBuilder(app_main.APP_MAIN.customer.Envelope.Builder other) {
    if (other == null) {
      return new app_main.APP_MAIN.customer.Envelope.Builder();
    } else {
      return new app_main.APP_MAIN.customer.Envelope.Builder(other);
    }
  }
   ...
   * @return A new Envelope RecordBuilder
   */
  public static app_main.APP_MAIN.customer.Envelope.Builder newBuilder(app_main.APP_MAIN.customer.Envelope other) {
    if (other == null) {
      return new app_main.APP_MAIN.customer.Envelope.Builder();
    } else {
      return new app_main.APP_MAIN.customer.Envelope.Builder(other);
  ...
  public static class Builder extends org.apache.avro.specific.SpecificRecordBuilderBase<Envelope>
    ...
    private app_main.APP_MAIN.customer.Value before;
    private app_main.APP_MAIN.customer.Value.Builder beforeBuilder;
    private app_main.APP_MAIN.customer.Value after;
    private app_main.APP_MAIN.customer.Value.Builder afterBuilder;
    private io.debezium.connector.mysql.Source source;
     ...
     * @param other The existing Builder to copy.
     */
    private Builder(app_main.APP_MAIN.customer.Envelope.Builder other) {
      super(other);
      ...
      if (other.hasBeforeBuilder()) {
        this.beforeBuilder = app_main.APP_MAIN.customer.Value.newBuilder(other.getBeforeBuilder());
      }
      ...
      if (other.hasAfterBuilder()) {
        this.afterBuilder = app_main.APP_MAIN.customer.Value.newBuilder(other.getAfterBuilder());
      }
     ...
     * @param other The existing instance to copy.
     */
    private Builder(app_main.APP_MAIN.customer.Envelope other) {
      super(SCHEMA$);
      if (isValidValue(fields()[0], other.before)) {
        this.before = data().deepCopy(fields()[0].schema(), other.before);
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder setBefore(app_main.APP_MAIN.customer.Value value) {
     ...
     * @return This builder.
     */
    public app_main.APP_MAIN.customer.Value.Builder getBeforeBuilder() {
      if (beforeBuilder == null) {
        if (hasBefore()) {
          setBeforeBuilder(app_main.APP_MAIN.customer.Value.newBuilder(before));
        } else {
          setBeforeBuilder(app_main.APP_MAIN.customer.Value.newBuilder());
        }
      }
    ...
    public app_main.APP_MAIN.customer.Envelope.Builder setBeforeBuilder(app_main.APP_MAIN.customer.Value.Builder value) {
      clearBefore();
      beforeBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder clearBefore() {
      before = null;
      beforeBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder setAfter(app_main.APP_MAIN.customer.Value value) {
     ...
     * @return This builder.
     */
    public app_main.APP_MAIN.customer.Value.Builder getAfterBuilder() {
      if (afterBuilder == null) {
        if (hasAfter()) {
          setAfterBuilder(app_main.APP_MAIN.customer.Value.newBuilder(after));
        } else {
          setAfterBuilder(app_main.APP_MAIN.customer.Value.newBuilder());
        }
      }
      return afterBuilder;
    }
    ...
    public app_main.APP_MAIN.customer.Envelope.Builder setAfterBuilder(app_main.APP_MAIN.customer.Value.Builder value) {
      clearAfter();
      afterBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder clearAfter() {
      after = null;
      afterBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder setSource(io.debezium.connector.mysql.Source value) {
    ...
    public app_main.APP_MAIN.customer.Envelope.Builder setSourceBuilder(io.debezium.connector.mysql.Source.Builder value) {
      clearSource();
      sourceBuilder = value;
      return this;
    }
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder clearSource() {
      source = null;
      sourceBuilder = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder setOp(java.lang.CharSequence value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder clearOp() {
      op = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder setTsMs(java.lang.Long value) {
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder clearTsMs() {
      ts_ms = null;
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder setTransaction(event.block value) {
    ...
    public app_main.APP_MAIN.customer.Envelope.Builder setTransactionBuilder(event.block.Builder value) {
      clearTransaction();
    ...
    /**
      ...
      * @return This builder.
      */
    public app_main.APP_MAIN.customer.Envelope.Builder clearTransaction() {
      transaction = null;
    ...
    public Envelope build() {
      try {
        ...
        if (beforeBuilder != null) {
          ...
          record.before = fieldSetFlags()[0] ? this.before : (app_main.APP_MAIN.customer.Value) defaultValue(fields()[0]);
        }
        if (afterBuilder != null) {
          try {
          ...
          record.after = fieldSetFlags()[1] ? this.after : (app_main.APP_MAIN.customer.Value) defaultValue(fields()[1]);
        }
        if (sourceBuilder != null) {
          try {
    ...
    throws java.io.IOException
  {
    ...
    if (fieldOrder == null) {
      if (in.readIndex() != 1) {
        ...
        if (this.before == null) {
          this.before = new app_main.APP_MAIN.customer.Value();
        }
      ...
      if (in.readIndex() != 1) {
        ...
        if (this.after == null) {
          this.after = new app_main.APP_MAIN.customer.Value();
        }
